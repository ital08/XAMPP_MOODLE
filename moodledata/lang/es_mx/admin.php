...
Si es proporcionada una clave Google Maps API V3, la localización de dirección IP es mostrada usando Google Maps. Usted necesita  tener una cuenta Google y solicitar una clave API de Google Maps. Si no es proporcionada una clave Google Maps API V3, la localización de dirección IP es mostrada usando OpenStreetMap.';
...
$string['supportpage'] = 'Enlace hacia contacto de soporte del sitio';
...
$string['upgradepluginsinfo_link'] = 'admin/cron';
