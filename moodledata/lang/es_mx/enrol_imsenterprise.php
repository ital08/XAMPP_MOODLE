...
Los usuarios son buscados en primer lugar por su "número ID", y en segundo lugar por su nombre_de_usuario en Moodle. Las contraseñas no son importadas por el plugin de IMS Enterprise. El uso de un plugin de autenticación de Moodle está recomendado para autenticar a los usuarios.';
